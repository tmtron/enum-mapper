...
public final class ColorEnum_MapperFull {
    public static <V> IsetBLUE<V> setRED(V value) {
        ...
        result.enumMapperBuilder.put(AllAnnotations_Source.ColorEnum.RED, value);
        return result;
    }

    public interface IsetBLUE<V> {
        EnumMapperFull<AllAnnotations_Source.ColorEnum, V> setBLUE(V value);
    }

    private static class StagedBuilder<V> implements IsetBLUE<V> {
        private final EnumMapperFull.Builder<AllAnnotations_Source.ColorEnum, V> enumMapperBuilder = EnumMapperFull
                .builder
                        (AllAnnotations_Source.ColorEnum.class);

        @Override
        public EnumMapperFull<AllAnnotations_Source.ColorEnum, V> setBLUE(V value) {
            enumMapperBuilder.put(AllAnnotations_Source.ColorEnum.BLUE, value);
